...
{% set fee_sources = [
    'int_mainnet_fees_gas_exponential',
    'int_mainnet_fees_gas_logarithmic',
    'int_mainnet_fees_gas_mean',
    'int_mainnet_fees_gas_sigmoid',
    'int_mainnet_fees_gas_sqrt',
    'int_mainnet_fees_gas_var',
    'int_mainnet_fees_gas',
] %}
